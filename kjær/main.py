...
def main(drone_folder_path, satellite_folder_path, top_n=3):
    ...
    drone_images = image_loader.data_loader(get_drone_images(drone_folder_path))
    satellite_images = image_loader.data_loader(get_satellite_images(satellite_folder_path))
